	...
	factory: (require) => {
		...
		*/
		...
		function ModelRow(props) {
			...
			const reasoningChip = model.reasoning === null || !model.reasoning.declared ? react.default.createElement(Chip, { tone: "warn" }, "无推理等级") : react.default.createElement(Chip, { tone: "info" }, `推理: ${model.reasoning.levels.join("/")}`);
