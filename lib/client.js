		...
		*/
		...
		function FigmaMcpPage() {
			...
			const applyRead = () => {
				...
				setReadMessage(null);
				setError(null);
				rpc(clientCtx.get("connection"), SIGHT_RPC.figmaMcpApply, { mode: "read" }).then((value) => {
			...
			children.push(react.default.createElement("div", { style: GROUP }, react.default.createElement("div", { style: GROUP_HEAD }, react.default.createElement("span", null, "① 设计稿 → 代码"), react.default.createElement("span", { style: {
				fontSize: 11,
				opacity: .6
			} }, "只读插件"), readCfg === void 0 ? null : readCfg.configured ? react.default.createElement(Chip, { tone: "on" }, "已启用") : react.default.createElement(Chip, { tone: "off" }, "未启用")), react.default.createElement("div", { style: {
				padding: "10px 12px",
				display: "flex",
				flexDirection: "column",
				gap: 8
				...
				opacity: .75,
				lineHeight: 1.6
			} }, "让模型读取 Figma 设计稿并生成代码。数据通过 Figma Desktop 本地插件桥接，不调用 Figma REST API，不需要 Token 或代理。只能读取画布，不能创建、修改、删除节点。"), react.default.createElement("div", { style: {
				fontSize: 12,
				opacity: .85,
				lineHeight: 1.7,
				...
				fontWeight: 600,
				marginBottom: 4
			} }, "首次安装（一次性）"), react.default.createElement("div", null, "① 打开 Figma Desktop（网页版无法连接 localhost）"), react.default.createElement("div", null, "② Plugins → Development → Import plugin from manifest..."), react.default.createElement("div", null, "③ 选择下面的 manifest.json 路径"), react.default.createElement("div", { style: {
				fontFamily: "monospace",
				fontSize: 11,
				wordBreak: "break-all",
				marginTop: 2,
				opacity: .8
			} }, readCfg?.manifestPath ?? "（路径加载中…）"), react.default.createElement("div", { style: { marginTop: 4 } }, "④ 运行「Figma UI MCP Bridge」插件，看到绿点即已连接")), react.default.createElement("div", { style: {
				fontSize: 12,
				opacity: .6,
				lineHeight: 1.6
			} }, "导入后每次使用前运行插件；启用配置后重启 DSH Desktop。"), readMessage !== null ? react.default.createElement("div", { style: {
				fontSize: 12,
				color: "#4ade80",
				background: "rgba(34,197,94,0.08)",
				border: "1px solid rgba(34,197,94,0.35)",
				...
				disabled: busy !== "",
				onClick: applyRead
			}, busy === "read" ? "配置中…" : "启用"), readCfg !== void 0 && readCfg.configured ? react.default.createElement("button", {
				type: "button",
				style: BUTTON,
				disabled: busy !== "",
				onClick: removeRead
			...
			children.push(react.default.createElement("div", { style: {
				...
				fontSize: 11,
				opacity: .6
			} }, "需装 Figma 插件"), writeCfg === void 0 ? null : writeCfg.configured ? react.default.createElement(Chip, { tone: "on" }, "已启用") : react.default.createElement(Chip, { tone: "off" }, "未启用")), react.default.createElement("div", { style: {
				padding: "10px 12px",
				display: "flex",
				flexDirection: "column",
				gap: 8
				...
				opacity: .75,
				lineHeight: 1.6
			} }, "让模型直接在 Figma 画布上绘制/修改设计。"), react.default.createElement("div", { style: {
				fontSize: 12,
				opacity: .85,
				lineHeight: 1.7,
				background: "rgba(128,128,128,0.08)",
				...
				fontWeight: 600,
				marginBottom: 4
			} }, "首次安装（一次性）"), react.default.createElement("div", null, "① 打开 Figma 桌面版（须桌面版，网页版无法连 localhost）"), react.default.createElement("div", null, "② Plugins → Development → Import plugin from manifest..."), react.default.createElement("div", null, "③ 选择下面的 manifest.json 文件"), react.default.createElement("div", { style: {
				fontFamily: "monospace",
				fontSize: 11,
				wordBreak: "break-all",
				marginTop: 2,
				opacity: .8
			} }, writeCfg?.manifestPath ?? "（路径加载中…）"), react.default.createElement("div", { style: { marginTop: 4 } }, "④ 运行「Figma UI MCP Bridge」插件，看到绿点即已连接")), react.default.createElement("div", { style: {
				fontSize: 12,
				opacity: .6,
				lineHeight: 1.6
			} }, "之后每次只需在 Figma 里运行「Figma UI MCP Bridge」插件即可，无需重复导入。"), writeMessage !== null ? react.default.createElement("div", { style: {
				fontSize: 12,
				color: "#4ade80",
				background: "rgba(34,197,94,0.08)",
				border: "1px solid rgba(34,197,94,0.35)",
