		...
		*/
		...
		function FigmaMcpPage() {
			...
			const apply = () => {
				...
				setMessage(null);
				setError(null);
				rpc(clientCtx.get("connection"), SIGHT_RPC.figmaMcpApply, {}).then((value) => {
			...
			children.push(react.default.createElement("p", { style: {
				...
				opacity: .75,
				lineHeight: 1.6
			} }, "让模型直接在 Figma 里做设计：一键启用后，模型可读取当前画布、创建/修改页面元素。无需 Token、无需代理——通过 Figma 桌面版插件桥接，纯本地通信。写入后请重启 DSH Desktop 生效。"));
			children.push(react.default.createElement("div", { style: {
				...GROUP,
				marginTop: 4
				...
				color: "#ef4444",
				fontSize: 12
			} }, `读取配置失败: ${status.error}`) : null, status !== null && status.configured ? react.default.createElement("div", { style: {
				fontSize: 12,
				opacity: .75,
				display: "flex",
				flexDirection: "column",
				gap: 2
			} }, react.default.createElement("span", null, `配置文件: ${status.patchPath}`)) : null, react.default.createElement("div", { style: {
				fontSize: 12,
				opacity: .75,
				lineHeight: 1.6
			} }, "使用前需要：① 打开 Figma 桌面版；② 运行「Figma UI MCP Bridge」插件；③ 在对话里告诉模型连接 figma-ui-mcp。"), message !== null ? react.default.createElement("div", { style: {
				fontSize: 12,
				color: "#4ade80",
				background: "rgba(34,197,94,0.08)",
				border: "1px solid rgba(34,197,94,0.35)",
				...
				disabled: busy !== "",
				onClick: apply
			}, busy === "apply" ? "写入中…" : "启用 Figma MCP"), status !== null && status.configured ? react.default.createElement("button", {
				type: "button",
				style: BUTTON,
				disabled: busy !== "",
				onClick: remove
			}, busy === "remove" ? "移除中…" : "停用") : null))));
			return react.default.createElement("div", { style: {
				display: "flex",
				flexDirection: "column",
				gap: 14,
