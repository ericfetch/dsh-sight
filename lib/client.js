		...
		*/
		...
		function FigmaMcpPage() {
			...
			children.push(react.default.createElement("div", { style: {
				...
				fontSize: 11,
				opacity: .6
			} }, "一次性导入 · 两项功能通用")), react.default.createElement("div", { style: {
				padding: "12px",
				display: "flex",
				flexDirection: "column",
				gap: 10
				...
				opacity: .8,
				lineHeight: 1.6
			} }, "「设计稿 → 代码」与「AI 主动设计」在 Figma 端均使用同一个本地桥接插件。只需导入一次，使用时在 Figma 中保持插件运行即可。"), react.default.createElement("div", { style: {
				fontSize: 12,
				opacity: .9,
				lineHeight: 1.7,
			...
			} }, react.default.createElement("div", null, "① 打开 ", react.default.createElement("b", null, "Figma 桌面客户端"), "（网页版无法连接本地 localhost）"), react.default.createElement("div", null, "② 顶部菜单：Plugins → Development → Import plugin from manifest..."), react.default.createElement("div", null, "③ 导入下方插件清单文件："), react.default.createElement("div", { style: {
				display: "flex",
				alignItems: "center",
				gap: 8,
				marginTop: 4,
			...
			children.push(react.default.createElement("div", { style: {
				...
				fontSize: 11,
				opacity: .6
			} }, "安全只读"), readCfg === void 0 ? null : readCfg.configured ? react.default.createElement(Chip, { tone: "on" }, "已启用") : react.default.createElement(Chip, { tone: "off" }, "未启用")), react.default.createElement("div", { style: {
				padding: "12px",
				display: "flex",
				flexDirection: "column",
				gap: 10
				...
				opacity: .8,
				lineHeight: 1.6
			} }, "让模型读取 Figma 画布结构并直接生成前端代码（React/Vue/CSS 等）。严格只读，只能提取图层、样式、Token 与截图，绝对不会修改或删除画布节点。"), readMessage !== null ? react.default.createElement("div", { style: {
				fontSize: 12,
				color: "#4ade80",
				background: "rgba(34,197,94,0.08)",
				border: "1px solid rgba(34,197,94,0.35)",
